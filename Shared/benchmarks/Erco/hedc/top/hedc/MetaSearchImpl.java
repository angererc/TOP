...
public class MetaSearchImpl implements MetaSearch {
    ...
    public void topTask_search(Task now, Task later, Hashtable h, Writer wrt, MetaSearchRequest r) throws IOException {
    	...
    	this.topTask_search_2(joinTask, now, resultsTask, wrt);
    ...
    public void topTask_search_2(Task now, Task result, Task results, Writer wrt) throws IOException {
	...
	Task joinTask = new Task();
	this.topTask_search_3(joinTask, h);
    ...
    public void topTask_search_3(Task now, Hashtable h) {    	
